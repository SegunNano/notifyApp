    ...
    return (
        <>
            <form className="space-y-6" action={action}>
                <h5 className="text-xl font-medium text-gray-900 dark:text-white">Sign {' '}{type === 'Login' ? ('in') : ('up')}</h5>
                {type === 'Register' && (
                    <div>
                ...
                {type === 'Login' && (
                    <>
                        <div className="flex items-start">
                            ...
                            <Link href="/reset-password" className="ms-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Lost Password?</Link>
                        </div>
                    </>
                )}
                <button type="submit" className="w-full shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{type}</button>
                {type === 'Login' ? (
            ...
            <>
                ...
                <h5 className="text-xl font-medium text-center text-gray-900 dark:text-white mb-5">Or</h5>
                <form action=''>
