                    ...
                    <div className="md:order-3 flex justify-end items-center gap-x-1">
                        <div className="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 mt-1 md:mt-0 md:ms-1.5">
                            {session ? (
                                ...
                                <Link className="p-2 w-full flex items-center text-white text-sm hover:text-gray-100 focus:outline-hidden focus:text-gray-200 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500" href="/login">
